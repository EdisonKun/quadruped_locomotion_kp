#include <leg_motion/LegMotionBase.hpp>
#include <leg_motion/Footstep.hpp>
#include <leg_motion/EndEffectorTarget.hpp>
#include <leg_motion/EndEffectorTrajectory.hpp>
#include <leg_motion/LegMode.hpp>
#include <leg_motion/JointTrajectory.hpp>

namespace free_gait {
/**
 * @brief LegMotionBase::LegMotionBase
 * @param type
 * @param limb
 */
